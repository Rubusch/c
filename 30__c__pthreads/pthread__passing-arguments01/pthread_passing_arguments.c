...
/*
 ...
 - the pthread_create() routinge permits to pass ONE argument to the thread start routine.
...
int main(int argc, char** argv)
{
  ...
  for(cnt=0; cnt<NUM_THREADS; ++cnt){
    ...
    *(taskids[cnt]) = cnt;
    ...
    if(0 != (return_code = pthread_create(&threads[cnt], NULL, print_hello, (void*) taskids[cnt]))){
