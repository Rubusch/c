...
/*
  ...
  pthread_create(thread, attr, start_function, argument) - creates a new thread and executes it
  pthread_exit(status)       - the exit function when working with pthreads
