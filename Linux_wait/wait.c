...
/*
  ...
  Wait for child process termination. Makes a parent wait until 
  a child process is completed. BLOCKS calling process until the 
  child terminates. If the parent has various child processes, 
  wait() returns when one returns.
