...
int main()
{
	...
	/* utilities */
	TEST_start(pSuite, "find min element", test_find_min_element)
	...
	/* algorithm */
	pSuite = CU_add_suite("bucketsort", init_suite_bucketsort,
			      clean_suite_bucketsort);
	TEST_start(pSuite, "bucketsort", test_bucketsort)
	TEST_end();
