// route.c - unix!
/*
  routing socket support (still some if_nametoindex / if_indextoname missing, 
  supported by lib_socket)
//*/
...
char* _net_rt_iflist(int family, int flags, size_t *lenp)
{
  char *ptr=NULL;
...
char* _net_rt_dump(int family, int flags, size_t *lenp)
{
  char *ptr=NULL;
